...
def send_mail(yname, found_add, smtp_choose, mail_add, fail_sheet_add, mail_pwd):
    ...
    attachment = MIMEApplication(open('{}/{}.xls'.format(str(fail_sheet_add), yname), 'rb').read())
    attachment.add_header('content-Disposition', 'attachment', filename=('{}.xls'.format(str(yname))))
